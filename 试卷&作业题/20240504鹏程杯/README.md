...
鹏程杯整体上比CSP-J的代码题要多一些，所以应该多刷刷代码题。首先先把我们之前做的经典例题复习一遍，这些代码题我放到了课程网站：https://gitee.com/makeitagain/cpp-teaching/tree/main/ 的题库栏目下。其次一本通黄色的那本书上有很多习题，然后教师用书上有答案，可以作为后续刷题的资源。 